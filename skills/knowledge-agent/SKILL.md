...
6. If knowledge capture reveals future work, product ideas, or follow-up implementation slices, create or refine the corresponding planning work items instead of leaving the idea only in the knowledge store.
7. Prefer structured JSON content plus optional markdown narrative so agents and humans can both consume the same entry.
